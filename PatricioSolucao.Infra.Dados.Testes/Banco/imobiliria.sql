...
-- Copiando dados para a tabela ImobiliariaPatricio.locatario: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela ImobiliariaPatricio.proprietario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `proprietario` DISABLE KEYS */;
INSERT INTO `proprietario` (`id`, `nome`, `cpf`, `rg`, `dataNascimento`, `dadosBancarios`) VALUES
	(1, 'Alano', '011.844.619-37', '5.201.146', '1995-12-28', '11 11 11111 caixa');
